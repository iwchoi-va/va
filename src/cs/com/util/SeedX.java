...
//            AnsiX923Padding, CryptoPadding, Base64
...
public class SeedX
{
    ...
    private CryptoPadding padding;
    private String s_charset;
    ...
    public String encryptToString(String inData)
        throws UnsupportedEncodingException
    {
        return Base64.encode(encrypt(inData.getBytes(), s_key.getBytes()));
    }

    public String decryptToString(String encryptString)
        throws UnsupportedEncodingException
    {
    //    return new String(decrypt(Base64.decode(encryptString), s_key.getBytes()), s_charset);
        return new String(decrypt(Base64.decode(encryptString), s_key.getBytes()));
    }
