	...
	<xsl:template name="package">
		...
		<xsl:for-each select="/testsuites/testsuite[@package = $name]">
			...
			<xsl:if test="@failures != 0">
				<redirect:write
					file="{$output.dir}/{$package.dir}/{@id}_{@name}-fails.html">
					<xsl:apply-templates select="." mode="class.details">
						<xsl:with-param name="type" select="'fails'" />
					</xsl:apply-templates>
				</redirect:write>
			...
			<xsl:if test="@errors != 0">
				<redirect:write
					file="{$output.dir}/{$package.dir}/{@id}_{@name}-errors.html">
					<xsl:apply-templates select="." mode="class.details">
						<xsl:with-param name="type" select="'errors'" />
					</xsl:apply-templates>
				</redirect:write>
		...
		<html>
			...
			<body>
				...
				<!--table border="0" cellpadding="5" cellspacing="2" width="95%"> <xsl:call-template 
					name="class.metrics.header"/> <xsl:apply-templates select="." mode="print.metrics"/> 
					</table -->
