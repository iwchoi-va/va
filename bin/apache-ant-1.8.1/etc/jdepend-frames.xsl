...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	version="1.0" xmlns:lxslt="http://xml.apache.org/xslt" xmlns:redirect="org.apache.xalan.lib.Redirect"
	...
	<!-- Sample stylesheet to be used with JDepend XML output. It creates a 
		set of HTML files a la javadoc where you can browse easily through all packages 
		and classes. @author <a href="mailto:jtulley@novell.com">Jeff Tulley</a> -->
			...
			<body>
				...
				<xsl:for-each select="./Packages/Package">
					<xsl:if test="count(error) = 0">
						<h3>
							<a>
								<xsl:attribute name="name">PK<xsl:value-of
	...
	<xsl:template match="JDepend" mode="cycles.details">
		<html>
			...
			<body>
				...
				<!--<table width="100%"><tr><td> </td><td align="right"> [<a href="#NVsummary">summary</a>] 
					[<a href="#NVpackages">packages</a>] [<a href="#NVcycles">cycles</a>] [<a 
					href="#NVexplanations">explanations</a>] </td></tr></table> -->
				...
				<xsl:for-each select="Cycles/Package">
					<h3>
						<a>
							<xsl:attribute name="name">#CY<xsl:value-of
								select="@Name" /></xsl:attribute>
							<xsl:value-of select="@Name" />
						</a>
					</h3>
		...
		<html>
			...
			<body>
				...
				<p>
					...
					<a href="http://www.clarkware.com/software/JDepend.html">JDepend documentation</a>
					.
				</p>
				...
				<p>The ratio of the number of abstract classes (and interfaces) in
					the analyzed package to the total number of classes in the analyzed
					package. </p>
				...
				<p>The perpendicular distance of a package from the idealized line A
					+ I = 1. This metric is an indicator of the package's balance
				...
				<p>A package squarely on the main sequence is optimally balanced
					...
					concrete and instable (x=1, y=0). </p>
	...
	<!-- I do not know JDepend enough to know if every error results in a non-analyzed 
		package, but that is how I am presenting it to the viewer. This may need 
		to change. @bug there will be a problem here, I don't know yet how to handle 
		unnamed package :( -->
