...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- Stylesheet to transform an XML file generated by the Ant MAudit task 
		into a set of JavaDoc-like HTML page to make pages more convenient to be 
		browsed. It use the Xalan redirect extension to write to multiple output 
		files. @author Stephane Bailliez <a href="mailto:sbailliez@apache.org"/> -->
				...
				<table border="0" width="100%">
					<tr>
						<td style="text-align: justify;">
							...
							experience from the Java development community and insite experience.
							Violations are generally
							reported with a reference to the
							<a
								href="http://java.sun.com/docs/books/jls/second_edition/html/jTOC.doc.html">Java Language Specifications</a>
							(JLS x.x.x)
							...
							<a href="http://java.sun.com/docs/codeconv/html/CodeConvTOC.doc.html">Sun Java coding guidelines</a>
							in use at Jakarta.
							<p />
	...
	<xsl:template name="package.summary">
		...
		<HTML>
			...
			<BODY>
				...
				<!--table border="0" cellpadding="5" cellspacing="2" width="100%"> <xsl:call-template 
